...
def UNIT1_3():
    ...
    st.write(r"""
    The output elasticity for high-skill labor is represented by \( \alpha \). For example, if \( \alpha = 0.3 \), 
    a 1% increase in high-skill labor results in a 0.3% increase in output.
    """)

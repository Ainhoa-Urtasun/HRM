...
def UNIT1_2():
    ...
    placeholder='''A job is not the same as an occupation—an occupation is more general. 
    Occupations are standardized, while jobs are more flexible because they are defined by firms. 
    Firms decide which jobs to post.'''
    )

...
def UNIT1_1():
    ...
    st.write(
        '''
        We use these 3 online resources: 
        
        - [ESCO](https://esco.ec.europa.eu/en) European Skills, Competences, Qualifications and Occupations
...
def UNIT1_2():
    ...
    st.text_input("Select the occupation(s) in which you wish to post jobs from ISCO at [ESCO](https://esco.ec.europa.eu/en) and write their titles here:")

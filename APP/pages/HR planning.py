...
def HR_planning():
    ...
    with st.sidebar.expander("1. Other managers"):
    ...
    with st.sidebar.expander("2. Support intellectuals and scientists, technicians and professionals"):
    ...
    with st.sidebar.expander("3. Administrative employees"):

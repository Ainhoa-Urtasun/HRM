...
def UNIT2_2():
    ...
    with st.sidebar.expander("$t_1$ Intellectual"):
        s11 = st.number_input("$s_{11}$ Demonstrating willigness to learn",key='s11',step=1.0)
        s21 = st.number_input("$s_{21}$ Collaborating in teams and networks",key='s21',step=1.0)
        s31 = st.number_input("$s_{31}$ Working efficiently",key='s31',step=1.0)
        s41 = st.number_input("$s_{41}$ Taking a proactive approach",key='s41',step=1.0)
    with st.sidebar.expander("$t_1$ Physical"):
        s12 = st.number_input("$s_{12}$ Demonstrating willigness to learn",key='s12',step=1.0)
        s22 = st.number_input("$s_{22}$ Collaborating in teams and networks",key='s22',step=1.0)
        s32 = st.number_input("$s_{32}$ Working efficiently",key='s32',step=1.0)
        s42 = st.number_input("$s_{42}$ Taking a proactive approach",key='s42',step=1.0)
    with st.sidebar.expander("$t_1$ Social"):
        s13 = st.number_input("$s_{13}$ Demonstrating willigness to learn",key='s13',step=1.0)
        s23 = st.number_input("$s_{23}$ Collaborating in teams and networks",key='s23',step=1.0)
        s33 = st.number_input("$s_{33}$ Working efficiently",key='s33',step=1.0)
        s43 = st.number_input("$s_{43}$ Taking a proactive approach",key='s43',step=1.0)
    with st.sidebar.expander("$t_1$ Use of methods"):
        s14 = st.number_input("$s_{14}$ Demonstrating willigness to learn",key='s14',step=1.0)
        s24 = st.number_input("$s_{24}$ Collaborating in teams and networks",key='s24',step=1.0)
        s34 = st.number_input("$s_{34}$ Working efficiently",key='s34',step=1.0)
        s44 = st.number_input("$s_{44}$ Taking a proactive approach",key='s44',step=1.0)
    with st.sidebar.expander("$t_1$ Use of technology"):
        s15 = st.number_input("$s_{15}$ Demonstrating willigness to learn",key='s15',step=1.0)
        s25 = st.number_input("$s_{25}$ Collaborating in teams and networks",key='s25',step=1.0)
        s35 = st.number_input("$s_{35}$ Working efficiently",key='s35',step=1.0)
        s45 = st.number_input("$s_{45}$ Taking a proactive approach",key='s45',step=1.0)

...
def Training():
    ...
    plt.plot(['Before training','After training'],[t0,t1],color='red',label="Skill level of the promoted employee (Scale: 0-100)")
    plt.plot(['Before training','After training'],[n0,n1],color='blue',label="Skill level of the non-promoted employee (Scale: 0-100)")

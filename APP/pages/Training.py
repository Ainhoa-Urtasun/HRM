...
def Training():
    ...
    plt.plot(['Before training','After training'],[t0,t1],color='red',label="Trained employee's skill")
    plt.plot(['Before training','After training'],[n0,n1],color='blue',label="Non-trained employee's skill")

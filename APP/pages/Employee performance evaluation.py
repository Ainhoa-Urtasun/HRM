...
def Employee_performance():
    ...
    A = st.number_input(
        "Enter the value for $L_{1}^{0.15} L_{3}^{0.05} K^{0.2}$ using 2023 SABI data, by adding up women and men in $L_1$, and in $L_3$, and assuming, for $K$ that each technology depreciates by €500,000 yearly. Use English for decimals. Don't use the thousand separator):",

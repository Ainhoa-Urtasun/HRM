...
def firm_selection():
    ...
    st.text_area("Question 1: Power BI, a highly demanded software developed by Microsoft, enables businesses to make data-driven decisions by seamlessly integrating and visualizing data. 
    Your firm has decided to implement this powerful tool. Describe how Power BI can support your firm in the performance of its economic activities activities.", placeholder="Write here...") 

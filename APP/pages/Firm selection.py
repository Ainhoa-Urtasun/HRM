...
def firm_selection():
    ...
    st.write("""
    ### 1. Power BI, a highly demanded software developed by Microsoft, enables businesses to make data-driven decisions by seamlessly integrating and visualizing data. 
    ...
    st.write("""
    ### 2. Which job within your firm, do you think, should master the new technology? Why?
    """)
    st.text_area("", placeholder="Write here...") 
